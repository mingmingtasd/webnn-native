...
namespace webnn::native { namespace dml { namespace utils {
    ...
    class GraphDesc {
      public:
        ...
        DML_GRAPH_DESC ConvertGraphDesc(size_t inputCount, size_t outputCount) {
    ...
    void CloseExecuteResetWait111(ComPtr<ID3D12GraphicsCommandList> commandList,
                                  ComPtr<ID3D12CommandQueue> commandQueue,
                                  ComPtr<ID3D12CommandAllocator> commandAllocator,
                                  ComPtr<ID3D12Device> D3D12Device);
}}}  // namespace webnn::native::dml::utils
