...
namespace webnn::native::dml {
    ...
    class Graph : public GraphBase {
      public:
        ...
        DML_TENSOR_DESC CreateTensorDesc(
        ...
        DML_TENSOR_DESC CreateTensorDesc(DML_TENSOR_DESC const* tensorDesc,
                                         std::vector<UINT> dimensions = {},
                                         std::vector<UINT> strides = {},
                                         bool useDefaultFlags = false);
        DML_TENSOR_DESC AppendIdentity(const DML_TENSOR_DESC& inputTensorDesc);
        std::shared_ptr<InputNode> CreateConstantInput(
            void const* value,
            size_t size,
            const std::vector<UINT>& dimensions,
            const std::vector<UINT>& strides = {},
